          ...
          <div className="flex items-start gap-4 md:gap-6 lg:w-[45%]">
            ...
            <div className="text-left pt-2">
              <div className="flex items-center mb-2">
                <h2 className="text-xl md:text-2xl font-bold text-gray-800 mr-2 md:mr-3">
                  {animalInfo?.nome ? animalInfo.nome : (
                    <FontAwesomeIcon
                      icon={faSpinner}
                      className="animate-spin text-[var(--color-orange)] text-base md:text-xl flex-shrink-0"
                    />
                  )}
                </h2>
                {animalInfo?.sexo ? (
                  animalInfo?.sexo == "M" ? (
                    <FontAwesomeIcon
                      icon={faMars}
                      className="text-blue-500 text-base md:text-xl flex-shrink-0"
                    />
                  ) : (
                    <FontAwesomeIcon
                      icon={faVenus}
