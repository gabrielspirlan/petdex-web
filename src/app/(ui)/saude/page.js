        ...
        {loading ? (
          ...
          <>
            ...
            <div className="flex justify-center">
              <p className="max-w-[320px] md:max-w-full text-base font-medium text-black text-center leading-snug mb-6 break-words whitespace-normal md:whitespace-nowrap">
